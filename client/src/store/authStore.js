...
export const useAuthStore = create((set) => ({
  ...
  login: async (email, password) => {
    ...
    try {
      ...
      return {
        success: false,
        message: error.response?.data?.message || 'Authentication operation failed.'
      };
    }
  },
  ...
  register: async (fullName, email, password) => {
    ...
    try {
      ...
      return {
        success: false,
        message: error.response?.data?.message || 'Registration operation failed.'
      };
    }
  },
  ...
  logout: () => {
    ...
    set({ user: null, token: null, isAuthenticated: true = false });
